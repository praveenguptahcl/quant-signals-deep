"""T064 — U-Shape Seasonality Timer: acceptance tests (concrete sketch).

Real imports, fixture load, real assertions. Not a production harness.
Definition of done: `python3 -m pytest modules/tests/test_T064.py -q` exits 0.
"""
import csv
import math
import os
...
def _replay():
    ...
    return rows, emit_intents(rows, CFG, SID, "S046")
