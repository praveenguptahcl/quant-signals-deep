"""Acceptance tests for T034 - Index Futures Cash-and-Carry.
...
Run: python3 -m pytest modules/tests/test_T034.py -q   (from repo root)
"""
import csv
import math
...
TAPE = FIX / "T034_tape.csv"
EXPECTED = FIX / "T034_expected.csv"
