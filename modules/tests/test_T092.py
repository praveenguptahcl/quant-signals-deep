"""Acceptance tests for T092 — PIN-Gated Informed-Flow Avoidance.
...
Run: python3 -m pytest modules/tests/test_T092.py -q   (from repo root)
"""
import csv
import hashlib
import uuid
...
TAPE = FIX / "T092_tape.csv"
EXPECTED = FIX / "T092_expected.csv"
...
def test_cost_gate_predicate():
    ...
    assert not (cost <= k * 0.6000000000000001)  # tiny edge -> gate blocks
