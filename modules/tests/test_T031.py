"""Acceptance tests for T031 - Distance Pairs + Quality Filter.
...
Run: python3 -m pytest modules/tests/test_T031.py -q   (from repo root)
"""
import csv
import math
...
TAPE = FIX / "T031_tape.csv"
EXPECTED = FIX / "T031_expected.csv"
