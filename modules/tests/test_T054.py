"""T054 — Hurst/Variance-Ratio Regime Toggle: acceptance tests (concrete sketch).
...
SID = "T054"
TOL = 1e-6
CFG = {'mode': 'toggle', 'fade': False, 'z_long': 0.55, 'z_short': 0.45, 'conf_scale': 1.0, 'edge_mult': 80.0, 'time_stop': 30, 'exit_flip': False, 'k': 0.5, 'sizing': ('risk', 500.0, None), 'cooldown_bars': 2, 'bar_ns': 60000000000, 'tif': 'DAY', 'venue': 'XNAS', 'side_class': 'taker', 'adv_pct': 0.02, 'cost': {'spread_bps': 2.5, 'fee_bps': 0.4, 'borrow_bps': 0.0, 'impact_bps': 0.0}}
K = 0.5
...
def _replay():
    ...
    return rows, emit_intents(rows, CFG, SID, "S090")
