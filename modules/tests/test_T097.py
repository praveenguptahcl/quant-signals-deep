"""Acceptance tests for T097 — Sub-Hour Microstructure Reversal Scalper.
...
Run: python3 -m pytest modules/tests/test_T097.py -q   (from repo root)
"""
import csv
import hashlib
import uuid
...
TAPE = FIX / "T097_tape.csv"
EXPECTED = FIX / "T097_expected.csv"

GATE_CFG = [('>=', 1.0), ('<=', 5.0), ('>=', 1.0)]   # [(op, threshold)] for g1, g2, g3
GATE_NAMES = ['move_ok', 'spread_ok', 'time_ok']
COST_GATE_K = 0.5                       # [default]
PER_TRADE_R = 100        # $ risk per trade [example]
DAILY_LOSS_STOP_R = 20  # in units of R [default]
SYMBOL = 'SCP:XNAS'
PARENT_SIGNAL = 'S038'
