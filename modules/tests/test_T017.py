"""Concrete sketch: T017 Scheduled Macro-Announcement Drift.

Run: python3 -m pytest modules/tests/test_T017.py -q
"""
import csv
import math
import os
...
SID = "T017"
TAPE = os.path.join("modules", "fixtures", "T017_tape.csv")
EXPECTED = os.path.join("modules", "fixtures", "T017_expected.csv")
TOL = 1e-9
