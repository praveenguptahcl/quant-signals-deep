"""Acceptance tests for T080 — Multi-Source Attention Composite.
...
Run: python3 -m pytest modules/tests/test_T080.py -q   (from repo root)
"""
import csv
import hashlib
import uuid
...
TAPE = FIX / "T080_tape.csv"
EXPECTED = FIX / "T080_expected.csv"
...
def test_cost_gate_predicate():
    ...
    assert not (cost <= k * 1.4800000000000002)  # tiny edge -> gate blocks
