"""Acceptance tests for T087 — Purged-CV Strategy Selector.
...
Run: python3 -m pytest modules/tests/test_T087.py -q   (from repo root)
"""
import csv
import hashlib
import uuid
...
TAPE = FIX / "T087_tape.csv"
EXPECTED = FIX / "T087_expected.csv"

GATE_CFG = [('>=', 1.0), ('>=', 1.0), ('>=', 1.0)]   # [(op, threshold)] for g1, g2, g3
GATE_NAMES = ['haircut_ok', 'meta_ok', 'weight_ok']
