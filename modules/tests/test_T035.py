"""Acceptance tests for T035 - Futures Calendar-Spread Carry.
...
Run: python3 -m pytest modules/tests/test_T035.py -q   (from repo root)
"""
import csv
import math
...
TAPE = FIX / "T035_tape.csv"
EXPECTED = FIX / "T035_expected.csv"
