"""Acceptance tests for T033 - Johansen VECM Basket Arb.
...
Run: python3 -m pytest modules/tests/test_T033.py -q   (from repo root)
"""
import csv
import math
...
TAPE = FIX / "T033_tape.csv"
EXPECTED = FIX / "T033_expected.csv"
