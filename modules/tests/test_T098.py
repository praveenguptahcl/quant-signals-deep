"""Acceptance tests for T098 — Jump-Validated Momentum Ignition.
...
Run: python3 -m pytest modules/tests/test_T098.py -q   (from repo root)
"""
import csv
import hashlib
import uuid
...
TAPE = FIX / "T098_tape.csv"
EXPECTED = FIX / "T098_expected.csv"

GATE_CFG = [('>=', 1.0), ('>=', 2.0), ('>=', 1.0)]   # [(op, threshold)] for g1, g2, g3
GATE_NAMES = ['jump_ok', 'rvol_ok', 'drift_ok']
COST_GATE_K = 0.5                       # [default]
PER_TRADE_R = 350        # $ risk per trade [example]
DAILY_LOSS_STOP_R = 9  # in units of R [default]
SYMBOL = 'JMP:XNAS'
PARENT_SIGNAL = 'S064'
