"""Acceptance tests for T043 - GARCH Regime Filter.
...
Run: python3 -m pytest modules/tests/test_T043.py -q   (from repo root)
"""
import csv
import math
...
TAPE = FIX / "T043_tape.csv"
EXPECTED = FIX / "T043_expected.csv"
