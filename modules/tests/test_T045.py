"""Acceptance tests for T045 - VIX Term-Structure Carry.
...
Run: python3 -m pytest modules/tests/test_T045.py -q   (from repo root)
"""
import csv
import math
...
TAPE = FIX / "T045_tape.csv"
EXPECTED = FIX / "T045_expected.csv"
