"""Acceptance tests for T038 - Sector Momentum + Idiosyncratic Fade.
...
Run: python3 -m pytest modules/tests/test_T038.py -q   (from repo root)
"""
import csv
import math
...
TAPE = FIX / "T038_tape.csv"
EXPECTED = FIX / "T038_expected.csv"
