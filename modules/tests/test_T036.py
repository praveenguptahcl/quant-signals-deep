"""Acceptance tests for T036 - Cross-Asset Lead-Lag (Hayashi–Yoshida).
...
Run: python3 -m pytest modules/tests/test_T036.py -q   (from repo root)
"""
import csv
import math
...
TAPE = FIX / "T036_tape.csv"
EXPECTED = FIX / "T036_expected.csv"
