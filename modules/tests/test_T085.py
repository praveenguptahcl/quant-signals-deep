"""Acceptance tests for T085 — Resiliency Market Maker.
...
Run: python3 -m pytest modules/tests/test_T085.py -q   (from repo root)
"""
import csv
import hashlib
import uuid
...
TAPE = FIX / "T085_tape.csv"
EXPECTED = FIX / "T085_expected.csv"

GATE_CFG = [('>=', 1.0), ('>=', 1.0), ('>=', 1.0)]   # [(op, threshold)] for g1, g2, g3
GATE_NAMES = ['spread_ok', 'inv_ok', 'feed_ok']
COST_GATE_K = 0.5                       # [default]
PER_TRADE_R = 20        # $ risk per trade [example]
...
def test_cost_gate_predicate():
    ...
    assert not (cost <= k * 0.27999999999999997)  # tiny edge -> gate blocks
