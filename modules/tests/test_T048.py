"""Acceptance tests for T048 - Put/Call Ratio Contrarian.
...
Run: python3 -m pytest modules/tests/test_T048.py -q   (from repo root)
"""
import csv
import math
...
TAPE = FIX / "T048_tape.csv"
EXPECTED = FIX / "T048_expected.csv"
