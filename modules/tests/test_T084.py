"""Acceptance tests for T084 — Block-Trade Impact Reversion.
...
GATE_CFG = [('>=', 20.0), ('>=', 0.6), ('>=', 1.0)]   # [(op, threshold)] for g1, g2, g3
GATE_NAMES = ['block_mult', 'temp_share', 'kyle_ok']
COST_GATE_K = 0.5                       # [default]
PER_TRADE_R = 200        # $ risk per trade [example]
