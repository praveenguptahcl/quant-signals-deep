"""Acceptance tests for T095 — Dispersion + GEX Regime Switch.
...
Run: python3 -m pytest modules/tests/test_T095.py -q   (from repo root)
"""
import csv
import hashlib
import uuid
...
TAPE = FIX / "T095_tape.csv"
EXPECTED = FIX / "T095_expected.csv"

GATE_CFG = [('>=', 1.0), ('>=', 1.0), ('>=', 1.0)]   # [(op, threshold)] for g1, g2, g3
GATE_NAMES = ['contango', 'gex_pos', 'spread_ok']
COST_GATE_K = 0.5                       # [default]
PER_TRADE_R = 2000        # $ risk per trade [example]
