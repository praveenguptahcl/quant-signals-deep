"""T061 — Initial-Balance Expansion Trader: acceptance tests (concrete sketch).
...
SID = "T061"
TOL = 1e-6
CFG = {'mode': 'z', 'fade': False, 'z_long': 2.0, 'z_short': -2.0, 'conf_scale': 1.0, 'edge_mult': 3.0, 'time_stop': 60, 'exit_flip': False, 'k': 0.5, 'sizing': ('risk', 500.0, None), 'cooldown_bars': 30, 'bar_ns': 60000000000, 'tif': 'DAY', 'venue': 'CME', 'side_class': 'taker', 'adv_pct': 0.05, 'cost': {'spread_bps': 0.5, 'fee_bps': 0.3, 'borrow_bps': 0.0, 'impact_bps': 0.0}}
K = 0.5
...
def _replay():
    ...
    return rows, emit_intents(rows, CFG, SID, "S022")
