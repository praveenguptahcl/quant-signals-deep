"""Acceptance tests for T044 - Diurnal Deseasonalization Normalizer.
...
Run: python3 -m pytest modules/tests/test_T044.py -q   (from repo root)
"""
import csv
import math
...
TAPE = FIX / "T044_tape.csv"
EXPECTED = FIX / "T044_expected.csv"
