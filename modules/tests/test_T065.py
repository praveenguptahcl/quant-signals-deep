"""T065 — Open-Auction Imbalance Continuation: acceptance tests (concrete sketch).

Real imports, fixture load, real assertions. Not a production harness.
Definition of done: `python3 -m pytest modules/tests/test_T065.py -q` exits 0.
"""
import csv
import math
import os
