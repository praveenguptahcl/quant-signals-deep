"""Acceptance tests for T094 — Squeeze Breakout (Options-Confirmed).
...
Run: python3 -m pytest modules/tests/test_T094.py -q   (from repo root)
"""
import csv
import hashlib
import uuid
...
TAPE = FIX / "T094_tape.csv"
EXPECTED = FIX / "T094_expected.csv"

GATE_CFG = [('>=', 1.0), ('>=', 1.0), ('>=', 1.0)]   # [(op, threshold)] for g1, g2, g3
GATE_NAMES = ['break_ok', 'options_ok', 'vol_ok']
...
def test_cost_gate_predicate():
    ...
    assert not (cost <= k * 1.4000000000000001)  # tiny edge -> gate blocks
