...
datasets:
    ...
    - name: "US equities SIP bars"
      ...
      vintage: "30-day rolling window [default]"
      rights: "licensed"
      price_band: "$29–199/mo [unverified] (community plan summaries; verify at polygon.io/pricing)"
...
conflicts: []
unverified_sources: ["Hawkes-burst scalping P&L claims from practitioner sources — no citable P&L found; not promoted.", "Polygon.io plan prices ($29–199/mo) from community docs — verify at polygon.io/pricing before quoting.", "Databento Basic subscription $199/mo from third-party skill docs — verify at databento.com before quoting."]
supersedes: []
changelog:
    - date: "2026-09-10"
...
**Compliance (10 coded rules; full contract in §T8).**
...
9. `test_module_version_bump` — front-matter `version: "1.0.1"` and a deep-review changelog entry.
...
**Source log (verified during deep review v1.0.1).**
...
- Polygon.io plan prices ($29–199/mo) from community docs only — [unverified].
