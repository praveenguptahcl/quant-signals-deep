...
Cheapest viable path: **Massive Stocks plan** [documented — vendor pricing page https://massive.com/stocks-data, fetched 2026-09-11] (Starter $29/mo (15-min delayed, 5-yr history), Developer $79/mo (15-min delayed, 10-yr history), Advanced $199/mo (real-time, 20+ yr history); real-time on Advanced/Business only) — L1 bid/ask price + size per quote event, exchange timestamps. Build on the S001/S003 feed you already own; buy only the exchange-timestamped L1 feed.
...
Unit/exactness note: every tunable literal below mirrors a tagged `Config`/contract value above; the only untagged literals are exact conversion constants (`1e9` ns/s, `100` cents/$) and structural `0`/`1` sentinels.
...
| 10 | Massive Stocks plans $29/$79/$199/mo | vendor-direct | vendor pricing page https://massive.com/stocks-data, fetched 2026-09-11 | Starter $29/mo (15-min delayed, 5-yr history), Developer $79/mo (15-min delayed, 10-yr history), Advanced $199/mo (real-time, 20+ yr history) |
