...
1. Gao, L., Han, Y., Li, S.Z. & Zhou, G. (2018), "Intraday momentum: The first half-hour return predicts the last half-hour return", *Journal of Financial Economics*. — the S025 canonical result (slope ≈ 6.94 scaled, R² ≈ 1.6%).
2. Lee, C.M.C. & Ready, M.J. (1991), "Inferring trade direction from intraday data", *Journal of Finance*. — the Lee–Ready quote/tick rule used for S007.
...
4. Heston, S.L., Korajczyk, R.A. & Sadka, R. (2010), "Intraday patterns in time-series and cross-sectional stock returns", *Journal of Financial Economics*. — intraday return persistence, same-clock-slot variant.
