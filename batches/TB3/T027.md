...
1. Amihud, Y. (2002), "Illiquidity and stock returns: Cross-section and time-series effects", *Journal of Financial Markets*. — the ILLIQ universe gate.
2. Jegadeesh, N. (1990), "Evidence of predictable behavior of security returns", *Journal of Finance*; Lehmann, B.N. (1990), "Fads, martingales, and market efficiency", *Quarterly Journal of Economics*. — short-term reversal, the family this fade belongs to.
3. Cont, R., Kukanov, A. & Stoikov, S. (2014), "The price impact of order flow imbalance", *Journal of Financial Markets*. — impact decomposition into temporary and permanent components.
4. Lee, C.M.C. & Ready, M.J. (1991), "Inferring trade direction from intraday data", *Journal of Finance*. — shock-sign classification for the resiliency fit inputs.
