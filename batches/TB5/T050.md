...
Caption: watermarked "SYNTHETIC EXAMPLE" with corner note "synthetic data — not market data". Left: the synthetic wall map from T4 (seed 150): put wall 565 (−420), magnet 575 (+910), call wall 580 (+640). Right: the grind 579.80 → 575.65 — short 579.75, stop 583.20, magnet 575, cover 575.65, net +794.89 (1.15R).
