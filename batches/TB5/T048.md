...
All prices synthetic, **seed 148** (`rng = np.random.default_rng(148)`; regenerable via `python3 batches/TB5/plot_T048.py`). Costs: $0.005/share + 1 bp each way (*example*). The chart in T9 plots this exact 10-day path and both trades. Fictional large-cap "XLQ", 500 shares per trade. Synthetic 10-session tape (day: close, PCR z, S045 z, S097 z) — 0: 100.00, +0.4, −0.5, +0.1 · 1: 99.44, +1.1, −1.2, +0.9 · **2: 97.10, +2.6, −2.4, −2.4** ← put-panic · 3: 98.40, +0.7, −0.6, +0.5 · 4: 102.17, −0.3, +0.4, −0.2 · 5: 101.07, −0.9, +1.1, −0.8 · 6: 99.42, −1.4, +1.6, −1.2 · **7: 101.60, −2.3, +2.1, +2.1** ← call-euphoria · 8: 100.20, +0.2, +0.3, 0.0 · 9: 101.85, +0.1, −0.2, +0.3.

**Trade T1 — long fade of put panic (winner).** Signal day 2: PCR z = +2.6 (96th percentile, *example*) with stretched-down session (S045 z = −2.4) and bearish social volume (S097 z = −2.4) → long **500 @ 98.40** (day-3 open, *example* fill). Exit day 5 at normalization: **sell @ 101.07**.
...
**Trade T2 — short fade of call euphoria (loser).** Signal day 7: PCR z = −2.3 (6th percentile, *example*) with stretched-up session (S045 z = +2.1) and bullish social surge (S097 z = +2.1) → short **500 @ 100.20** (day-8 open, *example* fill). The euphoria *continues*: exit day 9 **cover @ 101.85**.
