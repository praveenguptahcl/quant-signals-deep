...
**Step 2 — one ordering.** For ordering (A, B, C), the Cholesky factor is $F = [[0.024763,\ 0,\ 0],[0.006953,\ 0.021815,\ 0],[0.004889,\ 0.003083,\ 0.021571]]$. Then $[\psi F]_A = 0.2963(0.024763) + 0.2768(0.006953) + 0.2825(0.004889) = 0.0106431$, and $IS_A = 0.0106431^2 / 0.00019818 = 0.5716 \approx \mathbf{0.572}$; the same arithmetic gives $IS_B = 0.241$, $IS_C = 0.187$ for this ordering.
