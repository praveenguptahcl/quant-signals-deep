...
**Cost-model note.** The 0.5¢/share MOC slippage (T2) is omitted from the displayed ledger — Day 1/2's MOC exits carry only the half-spread. Adding it ($0.005 × 2,000 shares = $10.00 per traded day) would move Day 1 to +$309.00, Day 2 to +$209.00, and the four-day book to +$518.00. The chart plots the displayed (partial-cost) ledger.
