...
**Leg A — Event 1 (ALP, FOLLOW, identified fresh news).** Jump `+3.21%` with an identified, high-novelty story (`nov = 0.97`); rule: follow with 12,000 shares. Buy 12,000 @ 50.000; drift continues — sell @ 50.280 (+28 bp). Gross: `12,000 × 0.280` = **+$3,360.00**; fees `12,000 × 2 × $0.0008` = **−$19.20**; **net +$3,340.80**.

**Leg B — Event 5 (EPS, FADE, no-news jump).** Jump `−3.44%` with no matched story; rule: fade with 8,000 shares. Buy 8,000 @ 50.000 (against the down-jump); reversal — sell @ 51.148 (+114.8 bp). Gross **+$9,184.00**; fees **−$12.80**; **net +$9,171.20**.

**Leg C — Event 4 (DEL, FOLLOW(earnings), SUE-scaled).** Earnings jump `+3.46%`, SUE = 3.6 → size `12,000 × min(1, 3.6/3)` = 12,000 shares. Buy 12,000 @ 50.000; the drift fails — sell @ 49.189 (−81.1 bp). Gross **−$9,732.00**; fees **−$19.20**; **net −$9,751.20** — the largest loss on the tape, and the honest one: earnings drift is a statistical tendency, not a law, and the SUE-scaled size cuts both ways.

**Full synthetic ledger** (net = gross − fees; cum = running total):

| # | Name | Jump | Class | Leg | Side | Shares | Entry | Exit | Net ($) | Cum ($) |
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | ALP | +3.21% | ident | FOLLOW | +1 | 12,000 | 50.000 | 50.280 | +3,340.80 | 3,340.80 |
| 2 | BET | −3.31% | no-news | FADE | +1 | 8,000 | 50.000 | 50.300 | +2,387.20 | 5,728.00 |
| 3 | GAM | +2.63% | stale | SKIP | 0 | 0 | — | — | 0.00 | 5,728.00 |
| 4 | DEL | +3.46% | earn | FOLLOW | +1 | 12,000 | 50.000 | 49.189 | −9,751.20 | −4,023.20 |
| 5 | EPS | −3.44% | no-news | FADE | +1 | 8,000 | 50.000 | 51.148 | +9,171.20 | 5,148.00 |
| 6 | ZET | +2.65% | no-news | FADE | −1 | 8,000 | 50.000 | 49.867 | +1,051.20 | 6,199.20 |
| 7 | ALP | +2.62% | ident | FOLLOW | +1 | 12,000 | 50.000 | 49.998 | −43.20 | 6,156.00 |
| 8 | BET | +1.63% | no-news | FADE | −1 | 8,000 | 50.000 | 49.165 | +6,667.20 | 12,823.20 |
| 9 | GAM | −2.98% | earn | FOLLOW | −1 | 10,800 | 50.000 | 49.586 | +4,453.92 | 17,277.12 |
| 10 | DEL | −2.94% | no-news | FADE | +1 | 8,000 | 50.000 | 49.838 | −1,308.80 | 15,968.32 |
| 11 | EPS | +2.84% | ident | FOLLOW | +1 | 12,000 | 50.000 | 50.708 | +8,476.80 | 24,445.12 |
| 12 | ZET | −2.06% | no-news | FADE | +1 | 8,000 | 50.000 | 50.961 | +7,675.20 | 32,120.32 |

**Tape net: +$32,120.32** across 11 traded legs and 1 skip. Mix: 4 follow legs (3 wins, 1 loss), 6 fade legs (4 wins, 2 losses), 1 stale skip. The loss profile is instructive: the two fade losses (events 10, and the small event-7 follow) show reversals that kept going; the earnings loss (event 4) shows the drift leg's tail.
...
**M5 Max feasibility.** Feasible — this is an event-driven equity strategy with minute-scale decisions, not a tick race. The classification service (embedding lookup + rules) runs in milliseconds. Verdict pattern (per cost-model §7): *feasible on the M5 Max (Tier H data-wise, eng Tier H, ~160–320 h ≈ $24k–48k loaded-cost estimate + news/earnings licenses; bottleneck is news-data licensing and the borrow desk relationship, not compute).*
...
|---|---|---|---|---|
| Tier 0: SEC EDGAR + earnings calendars | Filings, dates, some consensus | ~$0 | Free earnings dates | No timely jump news; manual matching |
...
*Caption: twelve synthetic jump events (seed 160) through the identified-news classifier — follow legs (green), earnings-follow legs (purple), fade legs (red), one stale skip (grey). Tape net +$32,120.32; worst leg −$9,751.20 (earnings follow, event 4). Watermark reads "SYNTHETIC EXAMPLE"; corner caption: "synthetic data — not market data".*
...
5. Livnat, J. & Mendenhall, R. R. (2006). "Comparing the Post–Earnings Announcement Drift for Surprises Calculated from Analyst and Time Series Forecasts." *Journal of Accounting Research* 44(1), 177–205. https://doi.org/10.1111/j.1475-679X.2006.00194.x
