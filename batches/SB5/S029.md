...
| | |
|---|---|
| **What it is** | Breakout signal when price *closes* outside a volatility envelope: Keltner = EMA ± k·ATR; Bollinger = SMA ± k·σ. |
...
| **Build-or-buy in one line** | Build — EMA/ATR/SMA/std on cheap 1–15-minute bars; the only real choice is *which* envelope definition you standardize on. |
...
- **T003 — VPIN-Gated Breakout Trader** — Keltner/Bollinger close-breakouts as breakout-timing candidates, taken only when order-flow toxicity (VPIN) is low; toxicity vetoes the trade.
