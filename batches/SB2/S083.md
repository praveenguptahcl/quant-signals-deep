...
| Practitioner replication (vpin) | Crypto (BTC perps) | Volume-time returns closer to normal than chronological-time | n/a | Practitioner replication |
