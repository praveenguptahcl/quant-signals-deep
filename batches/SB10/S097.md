...
**Cost of the hypothetical unvetoed trade** (spread + fees + impact/slippage, explicit): $50,000 in a $40 stock = 1,250 shares. Half-spread crossed both ways at 2¢ = $50. Venue/regulatory fees at $0.0035/share × 2 legs = $8.75. Impact/slippage at 3 bps = $15. Total ≈ **$74 ≈ 15 bps round trip** — the edge the signal would have to clear.
...
|---|---|---|
| Post firehose | X API pay-per-use (~$0.005/post read — bot-reported lead); Reddit commercial API (metered — bot-reported lead); StockTwits API | — (cannot build someone else's firehose) |
| Aggregated social metrics | LunarCrush / Santiment ~$50–1,000+/mo (bot-reported lead); Benzinga-class news ~$100–200/mo | Daily rollups from raw posts |
