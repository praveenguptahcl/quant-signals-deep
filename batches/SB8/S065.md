...
3. ***FIGARCH** (fractionally integrated GARCH) / long-memory* intraday models: persistence
   ...
   find it matches or beats short-memory GARCH on FX (before-cost forecast comparisons; FX
   FX-specific; evaluated with superior predictive ability and Diebold-Mariano tests — statistical
   tests of whether two competing forecasts have equal accuracy).
