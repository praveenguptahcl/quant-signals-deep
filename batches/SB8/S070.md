...
|---|---|---|---|---|
| Options quotes (ATM chain) | bid/ask | intraday snapshots / EOD | Tier 1–2 | OPRA (Options Price Reporting Authority, the consolidated US options tape) via Databento/Cboe LiveVol; delayed Cboe for prototyping |
