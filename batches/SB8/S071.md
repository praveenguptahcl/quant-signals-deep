...
|---|---|---|---|---|
| Options quotes (full chain) | bid/ask | intraday snapshots (15-min–hourly) | Tier 2 | OPRA (Options Price Reporting Authority, the consolidated US options tape) via Databento/Cboe LiveVol; Tier 0 delayed for EOD research |
